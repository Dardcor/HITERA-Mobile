...
class _PengaturanScreenState extends State<PengaturanScreen> {
  ...
  Future<void> _handleUpdateProfile() async {
    ...
    try {
      ...
      if (mounted) {
        HiteraToast.error(context, 'Gagal memperbarui profil.');
      }
    }
  ...
  Future<void> _handleChangePassword() async {
    ...
    try {
      ...
      if (mounted) {
        HiteraToast.error(context, 'Gagal memperbarui kata sandi.');
      }
    }
          ...
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                borderRadius: BorderRadius.circular(12),
                splashColor: HiteraColors.accentRedDim,
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.logout, color: HiteraColors.accentRed, size: 20),
                      ),
                      const SizedBox(width: 16),
                      const Text(
